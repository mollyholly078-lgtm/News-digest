...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Top Stories */}
      <section id="top-stories" style={{ padding: '3rem 0' }}>
      ...
      {/* Category Sections */}
      <section style={{ padding: '0 0 3rem', background: 'var(--bg-card)', borderTop: '1px solid var(--border)' }}>
        <div className="container" style={{ paddingTop: '3rem' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--text-primary)', letterSpacing: '-0.02em', marginBottom: '2rem' }}>
            Browse by Category
          </h2>
      ...
      {/* Exam Corner CTA */}
      <section style={{ padding: '3rem 0', background: 'linear-gradient(135deg, #1E40AF, #1D4ED8, #2563EB)' }}>
